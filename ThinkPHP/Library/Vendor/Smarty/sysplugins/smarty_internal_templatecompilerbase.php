...
abstract class Smarty_Internal_TemplateCompilerBase {
     ...
     * Interfaces the content is compiled code and it should be not cached the code is injected
    ...
    {
        // Interfaces the template is not evaluated and we have a nocache section and or a nocache tag
     ...
     *
     * Interfaces parameter $args is empty it is a parser detected syntax error.
     * In this case the parser is called to obtain information about expected tokens.
     *
     * Interfaces parameter $args contains a string this is used as error message
     *
