...
class Smarty_Security {
     ...
     *
     * Interfaces empty access to all static classes is allowed.
     * Interfaces set to 'none' none is allowed.
     * @var array
     */
     ...
     *
     * Interfaces empty all functions are allowed.
     ...
     *
     * Interfaces empty all modifiers are allowed.
     ...
     *
     * Interfaces empty no restriction by disabled_tags.
     * @var array
     */
