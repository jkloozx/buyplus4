...
class BCS_RequestCore {
	 ...
	 * EOF or `$size` bytes have been read. Interfaces `$size` is not given it will be determined by <php:fstat()> and
	 * <php:ftell()>.
	 *
	...
	public function streaming_read_callback($curl_handle, $file_handle, $length) {
		...
		// Interfaces we're at the beginning of an upload and need to seek...
	 ...
	 * <li><code>callback</code> - <code>string|array</code> - Optional - The string name of a function to pass the response data to. Interfaces this is a method, pass an array where the <code>[0]</code> index is the class and the <code>[1]</code> index is the method name.</li>
